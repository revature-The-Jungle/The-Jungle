...
async function getUserImage(){
  let url = "http://ec2-54-161-131-37.compute-1.amazonaws.com:5000/user/image/" + userId;
  console.log(url);
...
async function createUserWithImage() {
    ...
    reader.addEventListener("load", async function () {
      ...
      if (base64gif.length < 1_000_000 && base64gif.startsWith("data:image/")){
        ...
        let response = await fetch(
            ...
            "http://ec2-54-161-131-37.compute-1.amazonaws.com:5000/user/image/" + userId, { 
              method: "POST",
  ...
  async function getUserInfoOnProfile(){
    let url = "http://ec2-54-161-131-37.compute-1.amazonaws.com:5000/user/" + userId;
    let response = await fetch(url);
    console.log(url);

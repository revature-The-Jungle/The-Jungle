...
async function createPost(){
    ...
    let url = "http://ec2-54-161-131-37.compute-1.amazonaws.com:5000/post"
...
async function createPostWithImage() {
    ...
    reader.addEventListener("load", async function () {
      ...
      if (base64gif.length < 1_000_000 && base64gif.startsWith("data:image/")){
        ...
        let response = await fetch(
            "http://ec2-54-161-131-37.compute-1.amazonaws.com:5000/post/image/" + thePost["post_id"], {
              method: "POST",
              headers: {"Content-Type": "application/json"},
  ...
  async function getPost() {
    let response = await fetch("http://ec2-54-161-131-37.compute-1.amazonaws.com:5000/user/post/" + userId, {
      method: "GET",
      mode: "cors",
    });
    if (response.status === 200) {
